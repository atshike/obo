...
<title><?php echo ($vo["title"]); ?>-搜索-乄無时博客</title>
...
<h4>文章搜索</h4>
<ul>
<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li>[<?php echo ($vo["typename"]); ?>]<a href="/index.php/home/index/show/id/<?php echo ($vo["id"]); ?>">

<?php echo (msubstr($vo["title"],0,70,'utf-8',false)); ?>
</a> <?php echo (date('Y-m-d',$vo["senddate"])); ?> <a href="/index.php/home/index/del/id/<?php echo ($vo["id"]); ?>">删除</a> 
<a href="/index.php/home/index/edit/id/<?php echo ($vo["id"]); ?>">修改</a></li><?php endforeach; endif; ?>  
 </ul>
